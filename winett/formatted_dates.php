...
<span id="formatted_date">
        <span class="tooltiptext"><?php echo $comment_row['date_commented']; ?></span>
    <?php 
    /*****************************************************************/
    $saved_time = $comment_row['date_commented'];
    ...
    if (!empty($interval->format('%a')))
    {
        ...
        elseif ($time_difference >= 28) 
        {
            ...
            {
                $time_difference = date('d',strtotime($comment_row['date_commented']))." ".$get_month;
            }
            else
            {
                $time_difference = date('d',strtotime($comment_row['date_commented']))." ".$get_month." ".date_format($formated_saved_time, "y");
            }   
        } 
        /****************/ /*///////// /* */  /* */ /*ui*/
    } 
