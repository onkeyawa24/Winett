...
<body>
	...
	<div class="panel" >		 
		...
		<div class="mains">
			<div class="sandie"> 
				<img id="image" class="te" src="./images/untitled.jpg" alt="Profile" data-toggle="modal" data-target="#myImage"> 
	      					...
	      					<div class="modal-content">
	        					<div class="modal-body">
	          						<button type="button" class="close" data-dismiss="modal">&times;</button>
	          						 <li><a href="profilepics.php" style="color: white;">Add new photo?</a></li>
	          						  
								</div>
							</div>
					</div>
				</div>
				<a href="profile.php"><p5 class="para"><b><?php echo $userRow['user_firstname']." ".$userRow['user_lastname']; ?></b></p5></a>
			</div>
			<aside>
			...
			<ul class="w3-navbar lists">
			    ...
			    <a href="city.html"><h8 class="btnz">Messages</h8></a>&nbsp
			    <a href="schools.php"><h8 class="btnz">People</h8></a>&nbsp
  ...
  <!--------------------------------------------------------------------->
	    ...
	    <div class="profiles">    
	        ...
	        <p>Bio : <?php echo $userRow2['bio']; ?></p>
	        <p>Joined on : <?php $date_created = strtotime($userRow['date_created']); echo date("d-M-Y", $date_created); ?></p><br>
	        <h2 class="h4"><a href="edit.php"><i class="glyphicon glyphicon-edit"></i>Update</a></h2> 
	    </div>
